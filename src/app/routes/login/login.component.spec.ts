...
describe('LoginComponent', () => {
  ...
  beforeEach(() => {
    ...
    responseProfile = new Profile(require("src/assets/testsSupport/login/profile/1.json"));
  ...
  it('Succesful Sign In', () => {
    ...
    fixture.whenStable().then(() => {
      ...
      expect(formData.controls['password'].value).toEqual("123456");
